...
void main()
{
	...
	{
		printf("Enter choice : \n");
		printf("1)add begin 2)add end 3)add middle 4)print data 5)save file 6)delete all nodes 7)delete node 8)count nodes 9)reverse print 10)rev print recursion 11)exit\n");
		scanf("%d",&op);
		switch(op)
		{
